...
class VerifyInvalidSearchWithNoResultSpec_15752_Levi_DE extends GebSpec {

	@DELevisSmoke
	def "verifyInvalidSearchWithNoResult"()
	{
		...
		then: "user goes to the failed search Page and verifying the Error Message along with no result grid"
