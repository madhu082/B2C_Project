...
class CustomerProfileInformationNEGATIVEdockersDE extends GebSpec{
	@DEDockersSmoke
	def "customerProfileInformationNEGATIVEdockersDE 15875"(){
		
		when: "going to Dockers DE Home page"
		to LevisHomePage
		at LevisHomePage
		toMyAccountPage()
