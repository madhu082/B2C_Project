...
class RemoveBillingAdrressSpec_15936_Dockers_DE extends GebSpec{
	...
	when:"We are into MyProfile-tab"
	     ...
	     openAdrressTab()
		 def BillingAddressbefore= BillingAddress.size()
		
	then:"Updating Billing adrress & logout"
	     RemoveBillingAdrressSection()
		 logOut()
	...
	then:"User re-enters address tab & verifies the added billing address"	
	    ...
	    at LevisMyAccountPage
	    openAdrressTab()
	    assert BillingAddressbefore-1==BillingAddress.size()
