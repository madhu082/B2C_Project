...
class VerifyProductsDisplayOnWomanJacketsCategoryPageLeviDE extends GebSpec {
	@DELevisSmoke
	def "verifyProductsDisplayOnWomanJacketsCategoryPageLeviDE 15701"()
	{
		...
		then: "Verify that products are displayed when accessing Woman Jackets & Vests Category page."
