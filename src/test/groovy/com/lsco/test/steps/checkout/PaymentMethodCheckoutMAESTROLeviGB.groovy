...
class PaymentMethodCheckoutMAESTROLeviGB extends GebSpec {
	@GBLevisSmoke
	def "paymentMethodCheckoutMAESTROLeviGB 15904"()
	{
		when: "going to Levis GB and clicking on My Account"
		to LevisHomePage
		at LevisHomePage
		toMyAccountPage()
		
		
		then: "user is at Levis Login Page and logging in"
		at LevisLoginPage
		leviLogin()
		...
		when: "user goes to Cart Page and selecting Maestro CC"
		to CartPage
		at CartPage
