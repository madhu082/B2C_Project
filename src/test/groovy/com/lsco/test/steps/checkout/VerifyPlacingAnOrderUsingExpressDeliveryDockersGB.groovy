...
class VerifyPlacingAnOrderUsingExpressDeliveryDockersGB extends GebSpec {
	@GBDockersSmoke
	def "verifyPlacingAnOrderUsingExpressDeliveryDockersGB 17694"()
	{
	...
	when: "user goes to Cart Page and proceed to check out using Express delivery Method"
	to CartPage
	at CartPage
	toCheckoutPageLatest()
	fillingShippingAddrDetails()
	selectingExpressDelivery()
	submitData()
	verifyexpressDeliveryContent()
	chooseAmex()

	
	then: "Checking out the order with Credit Card Detail and verifying the orders"
