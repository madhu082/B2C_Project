...
class CheckoutWithIDealCCLeviNL extends GebSpec{
    @NLLevisSmoke
	def "checkoutWithIDealCCLeviNL 16667_1"()
	{
		when: "going to Levi NL Home Page and clicking on My Account"
		to LevisHomePage
		at LevisHomePage
		toMyAccountPage()
		
		
		then: "user is at Levi NL Login Page and logging in"
		at LevisLoginPage
		leviLogin()
