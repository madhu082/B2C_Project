...
class CheckoutWithCarteBleueCCDockersFR extends GebSpec {
	@FRDockersSmoke
	def "checkoutWithCarteBleueCCDockersFR 16665_2"()
	{
		when: "going to Dockers FR and clicking on My Account"
		to LevisHomePage
		at LevisHomePage
		toMyAccountPage()
		
		
		then: "user is at Dockers FR Login Page and logging in"
		at LevisLoginPage
		leviLogin()
