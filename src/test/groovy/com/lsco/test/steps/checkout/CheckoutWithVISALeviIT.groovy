...
import com.lsco.test.ITLevisSmoke
...
class CheckoutWithVISALeviIT extends GebSpec {
	@ITLevisSmoke
	def "checkoutWithVISALeviIT 16672_1"()
	{
		when: "going to Levis IT Home Page and clicking on My Account"
		to LevisHomePage
		at LevisHomePage
		toMyAccountPage()
		
		
		then: "user is at Levis IT Login Page and logging in"
		at LevisLoginPage
		leviLogin()
