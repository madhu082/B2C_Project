...
class MenShirtsPage extends Page{

	static url = "/category/men/clothing/shirts/all"
	...
	static at = {
        driver.currentUrl.contains("/shirts")
        assert $("header>article>div>h1").text().toUpperCase() == PropertyProvider.getInstance().getLocalizedPropertyValue("MenShirts")
		return true
	}
